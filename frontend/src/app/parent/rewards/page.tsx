          ...
          <div className="bg-warning-50 border border-warning-200 rounded-xl p-4 flex items-center gap-4">
            ...
            <div className="flex-1">
              <p className="font-medium text-warning-800">
                {pendingRedemptions.length} rewards waiting to be fulfilled
              </p>
              <p className="text-sm text-warning-600">
                Review and fulfill redeemed rewards
              </p>
            </div>
            <Button
              variant="warning"
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        reward.isActive ? 'border-slate-200' : 'border-slate-200 opacity-60'
      )}
    >
