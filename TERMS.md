...
## 1. Who may accept these Terms

These Terms form an agreement between us and the **parent or legal guardian** who creates a
TaskBuddy account. You must be **18 or older** and able to enter a binding contract. Children use
TaskBuddy only through a child profile created and supervised by their parent/guardian; the
parent accepts these Terms on the child's behalf and is responsible for the child's use.

## 2. Acceptance

By creating an account or using TaskBuddy you agree to these Terms and to our
[Privacy Policy](PRIVACY.md). If you do not agree, do not use the service. If we make material
changes, we will notify you and, where required, ask you to re-accept.

## 3. The service

TaskBuddy is a family task-management application: parents create tasks and rewards, children
complete tasks (optionally with photo evidence) and earn points/XP, and parents approve
completions and manage rewards. We may add, change, or remove features over time.
...
You agree not to:
- misuse, disrupt, or attempt to gain unauthorised access to the service or other families' data;
- upload unlawful, harmful, or infringing content, or content that is inappropriate for a
  child-directed service;
- use the service to collect data about children other than your own;
- reverse engineer, scrape, or resell the service except as the law expressly permits.

We may suspend or terminate accounts that violate these Terms or the law, with notice where
practicable.

## 8. Content you provide

You (and your children, through you) retain ownership of the content you upload (such as task
photos). You grant us a limited licence to host and display that content **solely to operate the
service for your family**. We do not use your children's content for advertising or to train
unrelated products. Photo evidence is stored privately as described in the Privacy Policy.

## 9. Intellectual property

TaskBuddy and all related software, designs, and content are owned by Evolution Prime IT Ltd and
protected by law (see the LICENSE file). We grant you a limited, non-exclusive, non-transferable
right to use the service for your family's personal, non-commercial use. No other rights are
granted.

## 10. Service availability and changes

We aim to keep the service available but do not guarantee uninterrupted operation. We may modify,
suspend, or discontinue features, and will give reasonable notice of material adverse changes
where practicable.

## 11. Disclaimers

To the maximum extent permitted by law, the service is provided **"as is"** and **"as
available,"** without warranties of any kind. We do not warrant that the service will be
error-free or meet every requirement. Nothing in these Terms excludes liability that cannot be
excluded by law (including certain consumer rights).
...
You agree to indemnify us against claims arising from your misuse of the service or breach of
these Terms, to the extent permitted by law and subject to consumer protections.

## 14. Termination

You may stop using TaskBuddy and delete your account at any time. We may terminate or suspend
access for breach or where required by law. On termination, the data-deletion process in the
...
We may update these Terms; we will update the version number and notify you of material changes
in-app or by email, and seek re-acceptance where required.
